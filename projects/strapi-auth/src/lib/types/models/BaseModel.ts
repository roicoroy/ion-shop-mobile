...
export abstract class BaseModel {
  ...
  //   values: any,
  //   useFormGroupValuesToModel: any
  // ): void {
  //   const rawValues: any = this.getValuesToUse(values, useFormGroupValuesToModel);
  //   for (const key in this.addedFormControls as any) {
  //     if (rawValues[key]) {
  //       if (useFormGroupValuesToModel) {
  //         const control: any = this.addedFormControls[key] as any;
  //         if (control instanceof UntypedFormControl as any) {
  //           this[key] = rawValues[key] as any;
